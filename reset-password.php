	...
	<div class="white-box">
		<div class="white-box-interior">
				...
				if (isset($errorstate)) {
					switch ($errorstate) {
						...
						case 'token_used':
							...
							break;
						case 'too_many_today':
							$login_err_message = __("Hay 3 peticiones sin usar hechas en menos de 24 horas. Por favor, espere hasta que uno expire.",'cftp_admin');
							break;
					}
				...
				if (isset($state['email'])) {
					switch ($state['email']) {
						case 1:
							...
							$msg = __('Se ha enviado un correo con más instrucciones. Por favor, compruebe su bandeja de entrada para continuar.','cftp_admin');
			...
			?>
						...
						<form action="reset-password.php" name="resetpassword" method="post" role="form">
							<fieldset>
								...
								<p><?php _e("Por favor ingrese su cuenta de E-mail. Usted recibira un link para continuar el proceso",'cftp_admin'); ?></p>

								<div class="inside_form_buttons">
									<button type="submit" name="submit" class="btn btn-wide btn-primary"><?php _e('Solicite una nueva contraseña','cftp_admin'); ?></button>
								</div>
							</fieldset>
						</form>
			<?php
			...
			?>
						...
						<form action="reset-password.php?token=<?php echo html_output($got_token); ?>&user=<?php echo html_output($got_user); ?>" name="newpassword" method="post" role="form">
							<fieldset>
								...
								<div class="form-group">
									<label for="reset_password_new"><?php _e('Nueva contraseña','cftp_admin'); ?></label>
								...
								<p><?php _e("Por favor ingrese su nueva contraseña deseada. Después de eso, podrás iniciar sesión normalmente.",'cftp_admin'); ?></p>
			...
			<div class="login_form_links">
				<p><a href="<?php echo BASE_URI; ?>" target="_self"><?php _e('Regresar a la pagina de inicio.','cftp_admin'); ?></a></p>
			</div>
		</div>
