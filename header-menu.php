 ...
 */
if ( in_session_or_cookies( array( 11,10,9,8,7 ) ) )
{
	...
	*/
	...
	$items['clients']	= array(
								...
								'sub'	=> array(
												array(
													...
													'label'	=> __('Añadir nuevo cliente', 'cftp_admin'),
	...
	$items['groups']	= array(
								...
								'sub'	=> array(
												array(
													//'label'	=> __('Add new', 'cftp_admin'),
													'label'	=> __('Añadir nueva compañia', 'cftp_admin'),
													'link'	=> 'groups-add.php',
												),
												array(
													//'label'	=> __('Manage groups', 'cftp_admin'),
													'label'	=> __('Administrar Compañias', 'cftp_admin'),
													'link'	=> 'groups.php',
												),
												array(
													'divider'	=> true,
	...
	$items['users']		= array(
								...
								'sub'	=> array(
												array(
													//'label'	=> __('Add new', 'cftp_admin'),
													'label'	=> __('Añadir nuevo usuario', 'cftp_admin'),
													'link'	=> 'users-add.php',
												),
												array(
