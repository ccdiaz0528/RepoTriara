...
<form action="<?php echo html_output($form_action); ?>" name="addgroup" method="post" class="form-horizontal">
	<div class="form-group">
		...
		<label for="add_group_form_name" class="col-sm-4 control-label"><?php _e('Nombre de la compañia','cftp_admin'); ?></label>
		<div class="col-sm-8">
	...
	<div class="form-group assigns">
		...
		<label for="add_group_form_members" class="col-sm-4 control-label"><?php _e('Integrantes','cftp_admin'); ?></label>
		<div class="col-sm-8">
