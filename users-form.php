...
<form action="<?php echo html_output($form_action); ?>" name="adduser" method="post" class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" name="add_user_form_name" id="add_user_form_name" class="form-control required" placeholder="Nombre completo del usuario" value="<?php echo (isset($add_user_data_name)) ? html_output(stripslashes($add_user_data_name)) : ''; ?>" />
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<div class="input-group">
				...
				<input name="add_user_form_pass" id="add_user_form_pass" class="form-control <?php if ($require_pass) { echo 'required'; } ?> password_toggle" type="password"/>
	...
	<div class="form-group">
		...
		?>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select name="add_user_form_level" id="add_user_form_level" class="form-control">
						<option value="10" <?php echo (isset($add_user_data_level) && $add_user_data_level == '9') ? 'selected="selected"' : ''; ?>><?php echo USER_ROLE_LVL_10; ?></option>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="input-group">
						<input value="0" type="text" name="add_user_form_maxfilesize" id="add_user_form_maxfilesize" class="form-control"  readonly value="<?php echo (isset($add_user_data_maxfilesize)) ? html_output(stripslashes($add_user_data_maxfilesize)) : '';?>" />
