...
$login_button_text = __('Ingresar','cftp_admin');
							...
							$.ajax({
									...
									success: function(response)
									{
										...
										if ( json.status == 'success' ) {
											...
											$('#submit').html('<i class="fa fa-check"></i><span class="sr-only"></span> <?php _e('Redireccioando','cftp_admin'); ?>...');
            ...
            <form action="process.php?do=login" name="login_admin" role="form" id="login_form">
				...
				<fieldset>
					<div class="form-group">
						<label for="username"><?php _e('Nombre de usuario','cftp_admin'); ?> / <?php _e('E-mail','cftp_admin'); ?></label>
					...
					<div class="form-group">
						<label for="password"><?php _e('Contraseña','cftp_admin'); ?></label>
						<input type="password" name="password" id="password" class="form-control"/>
					</div>

					<div class="form-group">
						<label for="language"><?php _e('Idioma','cftp_admin'); ?></label>
...
*/?>
			...
			<div class="login_form_links">
				<p id="reset_pass_link"><?php _e("Olvidó su contraseña?",'cftp_admin'); ?> <a href="<?php echo BASE_URI; ?>reset-password.php"><?php _e('Cámbiela aquí.','cftp_admin'); ?></a></p>
				<?php
					if (CLIENTS_CAN_REGISTER == '1') {
				?>
						<p id="register_link"><?php_e("Don't have an account yet?",'cftp_admin'); ?> <a href="<?php echo BASE_URI; ?>register.php"><?php _e('Register as a new client.','cftp_admin'); ?></a></p>
				<?php
					} else {
				?>
						...
						<p><?php// _e("Si necesita una cuenta, favor solicítela a su TAM",'cftp_admin'); ?></p>
						<p><?php _e("Si necesitas una cuenta, por favor radica tu solicitud a través de nuestros canales de soporte técnico",'cftp_admin'); ?></p>
				<?php
					}
				?>
			</div>
