...
$allowed_levels = array(10,9,8,7,0);
...
?>
		...
		<b><p><?php _e('Favor, complete la siguiente información para finalizar el proceso de carga. Recuerde que "Título" "Asignacion" y "Categoria" son campos obligatorios','cftp_admin'); ?></p></b>
												...
												?>
													<div class="col-sm-6 col-md-3 column_even column">
														<div class="file_data">
															...
															<div class="form-group">
																<label for="file[<?php echo $i; ?>][expires_date]"><?php _e('Fecha de expiración', 'cftp_admin');?></label>
																	<div class="input-group date-container">
<!---->																		<input type="text" class="form-control" readonly id="file[<?php echo $i; ?>][expiry_date]" name="file[<?php echo $i; ?>][expiry_date]" value="<?php echo (!empty($expiry_date)) ? $expiry_date : date('d-m-Y',strtotime($expiry_date."+ 1 year")); ?>" readonly />
															...
															<div class="checkbox">
																...
																<!--input type="checkbox" name="file[<?php //echo $i; ?>][expires]" id="exp_checkbox_<?php //echo $i; ?>" value="1" <?php //if ($row['expiry_set']) { ?>checked="checked"<?php //} ?> /--> <?php //_e('File expires', 'cftp_admin');?>
																	<input type="hidden" name="file[<?php echo $i; ?>][expires]" id="exp_checkbox_<?php echo $i; ?>" value="1" checked="checked"/>
																</label>
															</div>
												...
												?>
														<div class="col-sm-6 col-md-3 assigns column">
															<div class="file_data">
																<?php
																	...
																	*/
																?>
																<h3><?php _e('ASIGNACIONES*', 'cftp_admin');?></h3>
																<label><?php _e('Seleccione el cliente al que pertenece', 'cftp_admin');?>:</label>
																<select multiple="multiple" name="file[<?php echo $i; ?>][assignments][]" class="form-control chosen-select" data-placeholder="<?php _e('Select one or more options. Type to search.', 'cftp_admin');?>" required>
														...
														<div class="col-sm-6 col-md-3 categories column">
															<div class="file_data">
																<h3><?php _e('CATEGORÍAS*', 'cftp_admin');?></h3>
																<label><?php _e('Add to', 'cftp_admin');?>:</label>
																<select multiple="multiple" name="file[<?php echo $i; ?>][categories][]" class="form-control chosen-select" data-placeholder="<?php _e('Select one or more options. Type to search.', 'cftp_admin');?>" required>
																	<?php
																		/**
